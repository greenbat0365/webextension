...
",
Line 10: All keys LS  ,"Company : ALL KEYS LOCKSMITH (LINE-10)
","Uleadz Technician: Line 10 : All Keys Tech
","Metro:  Los Angeles, CA",Service Area: No Service Area (No OOA Jobs),"Affiliates: None
",Hours of Operation: Monday - Sunday from 7:00 AM – 12:00 AM Emergency Lockouts: 24/7 : Open 7 Days a Week,Can't Do List: House / Business Key Duplicates No Motorcycles / Motorbikes,
Line 10: Mt Local LS  ,Company : MT Lock And Key (LINE-9) ,"Uleadz Technician: Line 9: MT Lock And Key
","Metro:  Los Angeles, California","Service Area: No Service Area (No OOA Jobs)
",Affiliates: None,Hours of Operation: Saturday - Thursday from 7:00 AM – 11:00 PM Friday from 7:00 AM – 7:00 PM Emergency Lockouts: 24/7 : Open 7 Days a Week,Can't Do List: House / Business Key Duplicates ,
Line 9: Mt lock and keys,Company : MT Lock And Key (LINE-9) ,"Uleadz Technician: Line 9: MT Lock And Key
","Metro:  Los Angeles, California","Service Area: No Service Area (No OOA Jobs)
",Affiliates: None,Hours of Operation: Saturday - Thursday from 7:00 AM – 11:00 PM Friday from 7:00 AM – 7:00 PM Emergency Lockouts: 24/7 : Open 7 Days a Week,Can't Do List: House / Business Key Duplicates ,
Line 12: Mobile LS of PGH,"Company : Pittsburgh Mobile LS (LINE-12)
...
",
Line 12: Mobile LS of PGH (Guarantee),"Company : Pittsburgh Mobile LS (LINE-12)
",Uleadz Technician: Line 12: Pittsburgh Mobile Tech.,"Metro:  Pittsburgh, PA",Service Area: Service area inside Uleadz,"Affiliates: None
","Hours of Operation: 7:30 AM - 11:00 PM : 7 Days a Week
","Can't Do List: No Can’t Do List
",`;
    ...
    complete: function(results) {
        ...
        for (var i = 0; i < arrayobj.length; i++) { 
          for (var x = 0; x < arrayobj[i].length; x++) { 
            console.log(arrayobj[40][0]);
            console.log(trimmedtech);
